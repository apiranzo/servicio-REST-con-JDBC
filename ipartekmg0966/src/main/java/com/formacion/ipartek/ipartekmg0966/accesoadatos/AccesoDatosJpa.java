...
public class AccesoDatosJpa {
	...
	//Creamos una EntityManagerFactory, una fábrica que encontrará sus entidades en la carpeta señalada
	private static EntityManagerFactory entityManagerFactory = Persistence
			.createEntityManagerFactory("com.formacion.ipartek.ipartekmg0966.entidades");
